...
class Car{
    ...
    public void drive() {
        System.out.println(color + " " + model + "가 " + speed + "km로 달립니다.");
    }
}
...
class Cat{
    ...
    public void meow(){
        System.out.println(age +"살 " + kind + "고양이 " + name + "가 야용하고 웁니다.");
    }
}
class Warrior{
    String name = "강감찬";
    ...
    public void attack(){
        System.out.println(name + "이 " + attack +"의 데이미지를 입힙니다.");
    }
    public void defense(){
        System.out.println(name + "이 " + defense +"의 데이미지를 방어힙니다.");
    }
}
